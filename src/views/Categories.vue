...
<!--                    </g>-->
<!--                </svg>-->
<!--                <svg height="20" viewBox="0 0 512 511" width="20" @click="editCategory(data)">-->
...
<script>
  ...
  export default {
    name: "Categories",
    components: {AddNewCategory, ListCategory, DashboardNav},
    data(){
      return{
        rout:''
      }
    ...
    computed: {
      ...mapState(['categories', 'addCategoryStatus'])
    },
    created() {
